#!/usr/bin/env python3
"""
Codex Harness — DeepSeek Harness 适配器

DeepSeek AI 工具的适配器实现。
...
class DeepSeekMemory(MemoryInterface):
    def __init__(self):
...
class DeepSeekContext(ContextInterface):
    def __init__(self):
...
class DeepSeekTools(ToolInterface):
    def __init__(self):
...
class DeepSeekConfig(ConfigInterface):
    def __init__(self):
...
class DeepSeekAdapter(AgentAdapter):
    ...
    def __init__(self):
        self.memory = DeepSeekMemory()
        self.context = DeepSeekContext()
        self.tools = DeepSeekTools()
    ...
    def get_capabilities(self) -> List[str]:
        return [
            "code_generation", "code_explanation", "refactoring",
            "debugging", "terminal", "file_read", "file_write",
            "reasoning", "math", "coding", "conversation",
        ]

#!/usr/bin/env python3
"""
Codex Harness — LangChain Agent 适配器

LangChain Agent 的适配器实现。
...
class LangChainMemory(MemoryInterface):
    """LangChain 记忆实现"""
    def __init__(self):
...
class LangChainContext(ContextInterface):
    """LangChain 上下文实现"""
    def __init__(self):
...
class LangChainTools(ToolInterface):
    """LangChain 工具实现"""
    def __init__(self):
...
class LangChainConfig(ConfigInterface):
    """LangChain 配置实现"""
    def __init__(self):
...
class LangChainAdapter(AgentAdapter):
    ...
    def get_capabilities(self) -> List[str]:
        return ["chain", "agent", "tool_calling", "memory", "retrieval", "planning"]

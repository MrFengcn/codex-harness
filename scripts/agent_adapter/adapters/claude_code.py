#!/usr/bin/env python3
"""
Codex Harness — Claude Code 适配器

Anthropic Claude Code CLI 工具的适配器实现。
...
class ClaudeCodeMemory(MemoryInterface):
    def __init__(self):
...
class ClaudeCodeContext(ContextInterface):
    def __init__(self):
...
class ClaudeCodeTools(ToolInterface):
    def __init__(self):
...
class ClaudeCodeConfig(ConfigInterface):
    def __init__(self):
...
class ClaudeCodeAdapter(AgentAdapter):
    """Claude Code CLI 适配器"""
    def __init__(self):
        self.memory = ClaudeCodeMemory()
        self.context = ClaudeCodeContext()
    ...
    def get_capabilities(self) -> List[str]:
        return [
            ...
            "cli_tool", "conversation", "reasoning",
        ]
